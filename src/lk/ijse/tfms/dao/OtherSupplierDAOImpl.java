...
public class OtherSupplierDAOImpl {
    public static ArrayList<OtherSupplierDTO> getSupplierData() throws SQLException, ClassNotFoundException {
    ...
    public static boolean updateSupplier(OtherSupplierDTO otherSupplierDTO, String supID) throws SQLException, ClassNotFoundException {
    ...
    public static boolean insertNewSupplier(OtherSupplierDTO otherSupplierDTO) throws SQLException, ClassNotFoundException {
