    ...
    public void start(Stage primaryStage) throws Exception {
       // primaryStage.getOnCloseRequest();
        ...
        void btnOrderOnAction (ActionEvent event) throws SQLException, ClassNotFoundException {
            String paymentID = PaymentFormController.generateNextPaymentID(PaymentDAOImpl.getCurrentPaymentID());
            ...
            if (buyerIdValid && stockIdValid && amount > 0) {
                ...
                // --- generate payment
                PaymentDTO paymentDTO = new PaymentDTO(paymentID, date, "tea sell", amount, "cash", "credit", buyerID, null, null);
                PaymentDAOImpl.insertNewPayment(paymentDTO);

                // --- Update stock
                TeaStockItemDAOImpl.updateAvailableQTY(stockID, qtyP, qtyOP, qtyFOP, qtyGFOP, qtyTGFOP, qtyFTGFOP, qtyBOP, qtyFBOP);
